...
import { ArrowLeft, Users, UserPlus, Building2, Shield, Activity, RefreshCw, Unlock } from 'lucide-react';
          ...
          <TabsContent value="security" className="space-y-6">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">Manage account lockouts and security settings</p>
              </div>
              <AccountUnlockCard />
            </div>
          </TabsContent>
