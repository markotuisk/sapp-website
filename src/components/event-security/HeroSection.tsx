...
const HeroSection: React.FC<HeroSectionProps> = ({ setServicesOpen }) => {
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-24 relative z-10">
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto">
          <h1 
            ...
            ref={ref}
          >
            Comprehensive <span className="text-sapp-blue">event security</span> solutions
          </h1>
          <p 
            className={cn(
