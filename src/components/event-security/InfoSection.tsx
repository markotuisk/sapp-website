        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
          <div className="order-2 md:order-1 md:col-span-7">
            <div className="grid grid-cols-1 sm:grid-cols-2 h-full gap-6">
              <div className="bg-white rounded-xl shadow-md border border-gray-100 p-5 hover:shadow-xl hover:scale-[1.02] transition-all duration-200 ease-in-out flex flex-col">
