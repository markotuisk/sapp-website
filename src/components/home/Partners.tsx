      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <Animated animation="fade-up">
          <div 
            ...
            aria-labelledby="become-partner-cta"
          >
            ...
            <div className="relative z-10 md:max-w-xl">
              <h3 id="become-partner-cta" className="text-2xl md:text-3xl font-display font-bold text-white mb-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  ...
                  asChild
                >
                  <Link to="/client-area" aria-label="Partner with SAPP Security">
                    Partner With Us
                  </Link>
                </Button>
              </div>
        ...
        <ContactFormDialog 
          ...
          defaultMessage="I'm interested in becoming a SAPP Security partner."
