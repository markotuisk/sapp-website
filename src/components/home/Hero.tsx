      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex flex-col items-center md:items-start text-center md:text-left md:w-1/2">
            ...
            <p 
              className={cn(
                "text-lg md:text-xl text-sapp-gray mb-8 max-w-2xl",
                isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              )}
            >
            ...
            <p 
              className={cn(
                "text-md text-sapp-blue italic mb-4 max-w-xl opacity-70 transition-all duration-700 delay-300",
                isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              )}
            >
            ...
            <div 
              className={cn(
                "flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4 transition-all duration-700 delay-300",
                isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              )}
            >
              <Button 
