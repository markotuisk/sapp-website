  ...
  return (
    ...
    >      
      <div className="p-6 flex-grow flex flex-col">
        <h3 className="text-xl font-display font-semibold mb-3 bg-accent-teal/10 text-accent-dark-blue p-3 rounded-md transition-all duration-300 hover:bg-accent-teal/20">{title}</h3>
